...
class Model(nn.Module):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.rnn_0 = nn.RNN(batch_first=True, input_size=64, hidden_size=64)
        self.multiheadattention_0 = nn.MultiheadAttention(batch_first=True, embed_dim=64, num_heads=2)
        self.multiheadattention_1 = nn.MultiheadAttention(batch_first=True, embed_dim=64, num_heads=2)
        self.layernorm_0 = nn.LayerNorm(normalized_shape=[64])
        self.linear_0 = nn.Linear(in_features=64, out_features=64)
        self.relu_0 = nn.ReLU()
