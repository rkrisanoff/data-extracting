...
class Model(nn.Module):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.conv2d_0 = nn.Conv2d(in_channels=1, out_channels=32, kernel_size=3, padding=1)
        self.relu_0 = nn.ReLU()
        self.conv2d_1 = nn.Conv2d(in_channels=32, out_channels=16, kernel_size=3, padding=1)
