...
class Model(nn.Module):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.multiheadattention_0 = nn.MultiheadAttention(batch_first=True, embed_dim=256, num_heads=4)
        self.layernorm_0 = nn.LayerNorm(normalized_shape=[256])
        self.multiheadattention_1 = nn.MultiheadAttention(batch_first=True, embed_dim=256, num_heads=4)
