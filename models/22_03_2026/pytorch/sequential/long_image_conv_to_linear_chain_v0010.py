...
class Model(nn.Module):
    ...
    def __init__(self) -> None:
        ...
        self.relu_0 = nn.ReLU()
        self.conv2d_1 = nn.Conv2d(in_channels=16, out_channels=64, kernel_size=3, padding=1)
        ...
        self.batchnorm2d_0 = nn.BatchNorm2d(num_features=64)
        self.adaptiveavgpool2d_0 = nn.AdaptiveAvgPool2d(output_size=[1, 1])
        self.flatten_0 = nn.Flatten()
        self.linear_0 = nn.Linear(in_features=64, out_features=32)
        self.tanh_0 = nn.Tanh()
