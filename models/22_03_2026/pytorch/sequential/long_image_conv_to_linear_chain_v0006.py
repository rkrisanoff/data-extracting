...
class Model(nn.Module):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.conv2d_0 = nn.Conv2d(in_channels=3, out_channels=16, kernel_size=3, padding=1)
        self.relu_0 = nn.ReLU()
        self.conv2d_1 = nn.Conv2d(in_channels=16, out_channels=16, kernel_size=3, padding=1)
        ...
        self.batchnorm2d_0 = nn.BatchNorm2d(num_features=16)
        self.adaptiveavgpool2d_0 = nn.AdaptiveAvgPool2d(output_size=[1, 1])
        self.flatten_0 = nn.Flatten()
        self.linear_0 = nn.Linear(in_features=16, out_features=32)
        self.tanh_0 = nn.Tanh()
        self.linear_1 = nn.Linear(in_features=32, out_features=32)
